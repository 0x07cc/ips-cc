...
class Stats:
    ...
    def print_stats(self):
        ...
        if totalPkt != 0:
            ...
            if nf2 and (int(nf2) > PRINT_AFTER_QUEUED_PACKETS
                ...
                self.log.uplog(queue_string)  # TODO Future: WARN
    ...
    def apriFileQueue(self):
        ...
        try:
            ...
            self.log.uplog("Cannot find nfnetlink_queue.")
            return None, None, None
        except OSError:
            # Puo' succedere se ci sono problemi con i permessi.
            self.log.uplog("Cannot open nfnetlink_queue.")
            return None, None, None
        ...
        try:
            ...
            self.log.uplog("Error while reading nfnetlink_queue.")
            return None, None, None

        # Verifica che il file abbia il numero di campi atteso.
        if len(nf_array) != 9:
            self.log.uplog("nfnetlink_queue file: unknown format.")
            return None, None, None
